    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="w-full max-w-md p-6 bg-white shadow-lg rounded-lg text-center">
          ...
          <p className="text-gray-600 mt-2">Thank you for registering. You can now <Link href="/login" className="text-blue-500 hover:underline">log in</Link> to your account.</p>
          <div className="mt-6">
